...
exports.UnresolvedTrack = exports.Track = void 0;
exports.reviveTrackLike = reviveTrackLike;
...
class UnresolvedTrack {
    ...
    async resolve(resolver) {
        ...
        if (!track) {
            throw new errors_js_1.TrackLoadError(`No playable result for "${this.query}".`, {
                query: this.query,
...
function reviveTrackLike(value) {
