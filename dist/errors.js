...
exports.TrackLoadError = exports.VoiceConnectionError = exports.JunieRestError = exports.JunieError = exports.JunieErrorCode = void 0;
...
})(JunieErrorCode || (exports.JunieErrorCode = JunieErrorCode = {}));
/** Base class of all errors thrown by Junie. */
class JunieError extends Error {
...
exports.JunieRestError = JunieRestError;
/** Thrown when Discord voice credentials don't arrive within the timeout. */
class VoiceConnectionError extends JunieError {
...
class TrackLoadError extends JunieError {
...
exports.TrackLoadError = TrackLoadError;
