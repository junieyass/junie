...
export type AutoplayResolver<TRequester = unknown> = (
  player: import('../player/Player.js').Player<TRequester>,
  lastTrack: import('../track/Track.js').Track<TRequester>,
) => Promise<import('../track/Track.js').Track<TRequester>[] | SearchQuery>;
...
export type StrategyStats = Pick<NodeStats, 'players' | 'playingPlayers' | 'cpu'> &
  Partial<Pick<NodeStats, 'frameStats'>>;
